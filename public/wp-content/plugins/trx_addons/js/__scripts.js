  ...
  function get_editor_settings($target, init_type) {
    ...
    if (
      ...
      var parallax_on =
        ...
        crop_on =
          parallax_on &&
          section_data.hasOwnProperty("parallax_crop") &&
          !trx_addons_is_off(section_data.parallax_crop);
      settings.push({
        ...
        crop:
          parallax_on && section_data.hasOwnProperty("parallax_crop")
            ...
            : "none",
        range_start:
          parallax_on && section_data.hasOwnProperty("parallax_range_start")
            ? section_data.parallax_range_start.size
            : 0,
        range_end:
          parallax_on && section_data.hasOwnProperty("parallax_range_end")
            ? section_data.parallax_range_end.size
            : 40,
        sticky_offset:
          parallax_on && section_data.hasOwnProperty("parallax_sticky_offset")
            ? section_data.parallax_sticky_offset.size
            : 0,
        duration:
        ...
        ease:
          parallax_on && section_data.hasOwnProperty("parallax_ease")
            ...
            : "power2",
        lag:
          parallax_on && section_data.hasOwnProperty("parallax_lag")
            ? section_data.parallax_lag.size
            : 0,
        x_start:
          parallax_on && section_data.hasOwnProperty("parallax_x_start")
            ? section_data.parallax_x_start.size
            : 0,
        x_start_unit:
          parallax_on && section_data.hasOwnProperty("parallax_x_start")
            ? section_data.parallax_x_start.unit
            : "px",
        x_end:
          parallax_on && section_data.hasOwnProperty("parallax_x_end")
            ? section_data.parallax_x_end.size
            : 0,
        x_end_unit:
          parallax_on && section_data.hasOwnProperty("parallax_x_end")
            ? section_data.parallax_x_end.unit
            : "px",
        y_start:
          parallax_on && section_data.hasOwnProperty("parallax_y_start")
            ? section_data.parallax_y_start.size
            : 0,
        y_start_unit:
          parallax_on && section_data.hasOwnProperty("parallax_y_start")
            ? section_data.parallax_y_start.unit
            : "px",
        y_end:
          parallax_on && section_data.hasOwnProperty("parallax_y_end")
            ? section_data.parallax_y_end.size
            : 0,
        y_end_unit:
          parallax_on && section_data.hasOwnProperty("parallax_y_end")
            ? section_data.parallax_y_end.unit
            : "px",
        scale_start:
          parallax_on && section_data.hasOwnProperty("parallax_scale_start")
            ? section_data.parallax_scale_start.size
            : 100,
        scale_end:
          parallax_on && section_data.hasOwnProperty("parallax_scale_end")
            ? section_data.parallax_scale_end.size
            : 100,
        rotate_start:
          parallax_on && section_data.hasOwnProperty("parallax_rotate_start")
            ? section_data.parallax_rotate_start.size
            : 0,
        rotate_end:
          parallax_on && section_data.hasOwnProperty("parallax_rotate_end")
            ? section_data.parallax_rotate_end.size
            : 0,
        opacity_start:
          parallax_on && section_data.hasOwnProperty("parallax_opacity_start")
            ? section_data.parallax_opacity_start.size
            : 1,
        opacity_end:
          parallax_on && section_data.hasOwnProperty("parallax_opacity_end")
            ? section_data.parallax_opacity_end.size
            : 1,
        crop_start:
          crop_on && section_data.hasOwnProperty("parallax_crop_start")
            ? section_data.parallax_crop_start.size
            : 100,
        crop_end:
          crop_on && section_data.hasOwnProperty("parallax_crop_end")
            ? section_data.parallax_crop_end.size
            : 100,
        text:
                ...
                if (content_wrap.length == 1) {
                  ...
                  if (stretch_to == "window") {
                    menu_item
                      ...
                      .find(".elementor-section-boxed > .elementor-container")
                      .css({ "max-width": "none" });
  ...
  function trx_addons_menu_collapse() {
    ...
    jQuery(
      ...
      sc_layouts_item_parent
        .find(">div:not(.elementor-background-overlay)")
        .each(function () {
          if (in_group > 1) {
            return;
          }
